...
function TeamPage({ go }) {
  const team = [
    { name: 'Daniel Hirth', role: 'Principal', photo: '../assets/photos/daniel-hirth-portrait.png', accent: 'var(--blue-400)', page: 'daniel-hirth',
    ...
    { name: 'Alex Reyhan', role: 'Managing Partner', photo: '../assets/photos/team-alex-reyhan.png', accent: 'var(--teal-400)',
